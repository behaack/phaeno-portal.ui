...
import type { AiAssistNextPageRequest, AiAssistResponse, NaturalLangRequest } from "../types/ai-assistant"
...
export const aiAssistantService = {
  ...
  naturalLanguageRequestForOrg: (id: string, body: NaturalLangRequest) =>
    api.post<AiAssistResponse, NaturalLangRequest>(`/ai-assistant/natural-lang-request/${enc(id)}`, body),

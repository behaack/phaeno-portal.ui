...
export const accountService = {
  ...
  passwordChange: (body: ChangePassword) =>
    api.post<null, ChangePassword>('/account/change-password', body),

  passwordRecoveryStart: (body: PasswordRecoveryStartRequest) =>
    api.post<null, PasswordRecoveryStartRequest>('/account/password-request-reset', body),

  passwordRecoveryConfirm: (body: PasswordRecoveryConfirmRequest) =>
    api.post<null, PasswordRecoveryConfirmRequest>('/account/password-confirm-reset', body),

  totpStart: (body: StartTotpEnrollmentRequest) =>
    api.post<StartTotpEnrollmentResponse, StartTotpEnrollmentRequest>('/account/totp-start', body),
  ...
  oobStart: (body: StartOobEnrollmentRequest) =>
    api.post<StartOobEnrollmentResponse, StartOobEnrollmentRequest>('/account/oob-start', body),

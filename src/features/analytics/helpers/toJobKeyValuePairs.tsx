...
export function toJobKeyValuePairs(job: DataPipelineItem | null | undefined) {
  ...
  const parsedResults =
    !job.metricsJson || job.metricsJson === 'output' ? null : safeParseJson(job.metricsJson)
  ...
  return [
    ...
    {
      label: 'Submitted On',
      value: <DisplayDateTime value={job.submittedAt} format="long-datetime" />,
    },
    {
      label: 'Started On',
      value: <DisplayDateTime value={job.startedAt} format="long-datetime" />,
    },
    {
      label: 'Completed On',
      value: <DisplayDateTime value={job.completedAt} format="long-datetime" />,
    },
    {
      label: 'Run Time',
      value: <DisplayTimeSpan startValue={job.submittedAt} stopValue={job.completedAt} />,
    },
    {

...
import { IconKey, IconPassword, IconSettings, IconShieldCheck } from '@tabler/icons-react'
  ...
  return (
    ...
    >
      <div className="min-h-96 py-3 px-2">
        ...
        >
          <PTabsList>
            <PTabsTab value="password" leftSection={<IconPassword size={15} />}>
              Change Password
            </PTabsTab>

            <PTabsTab value="two-factor" leftSection={<IconShieldCheck size={15} />}>
              Two-factor
            </PTabsTab>

            <CanRole role={['customer-admin', 'partner-admin']}>
              <PTabsTab value="api-keys" leftSection={<IconKey size={15} />}>
                Api Keys
              </PTabsTab>
            </CanRole>
          </PTabsList>
